                    ...
                    <div className="flex jusfity-between p-6 bg-black bg-opacity-75 pt-10 flex-col-reverse md:flex-row">
                        <section className="flex justify-center w-full">
                            <div className="h-screen sm-text-center text-center mt-2 md:mt-0 flex flex-col">
                                ...
                                <b>Comediante, cineaste y conductor</b> de La Hora Feliz y Pur de Patos</p>
                                <p className="text-lg md:text-2xl text-white">Además de ser el <b>primer Standupero</b> mexicano en grabar su propia película</p>
