                ...
                <section className="bg-content-tio  text-gray-600  mx-auto   flex-col md:flex-col">
                    <div className="flex jusfity-between p-6 bg-black bg-opacity-75 pt-10 flex-col-reverse md:flex-row">
                        <section className="flex justify-center w-full">
                            <div className="h-1/2 sm-text-center text-center mt-2 md:mt-0 flex flex-col">
                                ...
                                <b>Comediante, cineasta y conductor</b> de La Hora Feliz y Pur de Patos</p>
                                <p className="text-lg md:text-2xl text-white">Además de ser el <b>primer Standupero mexicano</b> en grabar su opera prima de forma independiente</p>
                                <div className="mt-5 sm:flex justify-center">
                                    <div className="rounded-md shadow">
                                        <a href='https://www.youtube.com/@TIOROBER_tiorober' target='_blank' className="w-full flex items-center justify-center px-8 py-3 border border-white text-base font-medium rounded-md text-white bg-blue md:py-4 md:text-lg md:px-10" to="/calendario">Mira aquí su contenido</a>
                                    </div>
                                </div>
